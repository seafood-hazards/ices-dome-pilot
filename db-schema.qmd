...
tribble(
  ...
  "project_id", "INTEGER",    "✓", "",  "",         "Primary Key. Auto-generated surrogate key.", "MPROG",
  "project",    "TEXT",       "",  "",  "",         "Monitoring programme code(s), e.g. CEMP or CEMP~NATL.", "PURPM",
  "purpose",    "TEXT",       "",  "",  "✓",          "Purpose code(s), e.g. T~S (Temporal trend and Spatial).", "",
...
tribble(
  ...
  "metpt",       "TEXT",       "",  "",                 "✓",          "Purification/separation method code.", "METPS",
  "metps",       "TEXT",       "",  "",                 "✓",          "Chemical fixation/preservation method code.", "METFP",
