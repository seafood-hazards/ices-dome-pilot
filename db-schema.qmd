...
tibble(
  ...
  Description = c(
    ...
    "Purpose code(s), e.g. T~S (Temporal trend and Spatial).",
    "Country name of the responsible institute.",
    "Code for the reporting laboratory / institute."
  ),
  `Look Up` = c(
    "MPROG",
    "PURPM",
...
tibble(
  ...
  Description = c(
    ...
    "Purification/separation method code.",
    "Chemical fixation/preservation method code.",
    "Chemical extraction method code.",
