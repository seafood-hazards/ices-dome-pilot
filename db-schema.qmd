...
tribble(
  ...
  "dist_to_coast", "REAL",       "",  "✓",          "Distance to the nearest coastline (km), computed with seastamp.",
  "est_country",   "TEXT",       "",  "✓",          "Nearest country (Natural Earth).",
  "country_code",  "TEXT",       "",  "✓",          "ISO 3166-1 alpha-3 code of the nearest country (e.g. GBR).",
  "municipality",  "TEXT",       "",  "✓",          "Nearest municipality (Eurostat GISCO LAU), Europe only.",
  "sea_name",      "TEXT",       "",  "✓",          "Sea or ocean name (IHO Sea Areas v3)."
)
```
