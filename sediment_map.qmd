...
db_url <- "https://github.com/seafood-hazards/ices-dome-pilot/releases/download/v0.1.0/pilot_ices_dome.sqlite"
local_db_name <- "pilot_ices_dome.sqlite"
...
db = FileAttachment("pilot_ices_dome.sqlite").sqlite()
...
value_range_result = db.query(`
  ...
  FROM (
    ...
    GROUP BY s.param, s2.longitude, s2.latitude
  ) t
  GROUP BY param
`)
...
map_data = db.query(`
  ...
  GROUP BY s2.longitude, s2.latitude
`)
