...
* **Projection:** a **Lambert Azimuthal Equal Area** projection centred on the data. seastamp derives the extent from the sampling points themselves rather than applying a fixed global projection, which matters here: ICES-DOME sites span from the Mediterranean to the Arctic, a range no single national projection covers well.
