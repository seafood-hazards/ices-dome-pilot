...
subtitle: Distance calculation to the nearest Norwegian coastline from core locations 
---

As the initial data analysis will be performed on the ICES-DOME sites located within Norwegian fjords and surrounding areas near the Norwegian coastline, the distances to the nearest coastline were calculated.
...
![](./image/dist_to_coast_ices-dome.webp){.zoomable width=80%}
