...
The site table stores unique geographic locations, keyed on latitude and longitude rounded to two decimal places.
...
subsample_tbl <- tribble(
  ...
  "depth_from",   "INTEGER",    "",  "",            "Top depth of the sample interval (m).",
  "depth_to",     "INTEGER",    "",  "",            "Bottom depth of the sample interval (m).",
...
measurement_tbl <- tribble(
  ...
  "vflag",           "TEXT",       "",  "✓",           "Validity flag.",
  "uncrt",           "REAL",       "",  "✓",           "Measurement uncertainty.",
  "metcu",           "TEXT",       "",  "✓",           "Method of calculating uncertainty.",
  "dcflag",          "TEXT",       "",  "✓",           "Data conversion flag(s).",
