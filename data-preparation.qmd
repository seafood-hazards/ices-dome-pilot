...
subtitle: "Translating and cleaning the ICES-DOME dataset"
---

This page outlines the data preparation steps required to standardize the ICES-DOME dataset. The original dataset contains Norwegian terminology and various missing (`NA`) values. Our goal is to translate the names into English, enforce consistent snake_case naming conventions, and handle missing or inconsistent values appropriately.
